...
CREATE TABLE MODELL_ENTRY (id int AUTO_INCREMENT PRIMARY KEY , MOBIL_TEL_HERSTELLER_ID int, modell_name VARCHAR (255), display_groeße int, prozessor_name VARCHAR (255), preis decimal(10));